      ...
      <div className="grid grid-cols-[repeat(auto-fill,minmax(280px,1fr))] gap-4">
        {user.addresses.map((item) => (
          <div className=" rounded-md shadow-sm bg-white border flex flex-col">
            <div className={`px-4 py-5 ${item.default && "bg-text-hover/30 "}`}>
            ...
            <div className="border-t px-4 py-2 mt-auto">
              <div className="flex justify-between">
                <button
                  ...
                  className="flex items-center uppercase text-sm font-medium disabled:text-gray-400 enabled:hover:bg-text-hover enabled:hover:text-white rounded-sm px-2"
